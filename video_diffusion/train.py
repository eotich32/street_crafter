...
if __name__ == "__main__":
    ...
    # 这段代码用来确认logdir的路径，如果是resume的话，就直接用resume的路径，否则用name和postfix来确定
    # 如果resume的话重新设置opt.resume_from_checkpoint
    ...
    try:
        ...
        # model
        model = instantiate_from_config(config.model)  # 初始化模型：vwm.models.diffusion.DiffusionEngine
        ...
        trainer_kwargs["strategy"].timeout = datetime.timedelta(seconds=3600),
